...
<div class="fixed-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark mx-background-top-linear" >
    <div class="container" >
      <a class="navbar-brand" href="index.php" style="text-transform: uppercase; font-size:35px;  "> Student Analysis System</a>
...
<h2>Queries</h2>
   <a href="mailto:educationtechademics@gmail.com" target="_blank"> <h2>Student_Analysis_System@gmail.com</h2></a>
</center>
</div>
</div>
<div class="col-md-6">
...
<h2>Student Analysis System Mon-Sat</h2>
<h2>+91-7155524589</h2>
</center>
...
<br>
   ...
   <a href="mailto:Student_Analysis_System@gmail.com" target="_blank"> <h2 style="color:white">admin@Student_Analysis_System.com</h2></a>
	   </center>
	   </div>
	   </div>
	   </div>
